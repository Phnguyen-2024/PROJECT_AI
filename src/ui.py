...
def load_gif_frames(gif_path, screen):
    frames = []
    ...
    try:
        ...
        for frame in range(image.n_frames):
            ...
            # frame_surface = pygame.transform.scale(frame_surface, (screen.get_width(), PANEL_TOP_HEIGHT))
...
gif_path = r"D:\Nam2 - Ki2\Artificial Intelligence\PROJECT_AI\src\hinhnen.gif"
gif_frames = None
frame_count = 0
current_frame = 0
frame_timer = 0
...
def show_start_screen(screen):
    global current_frame, frame_timer, gif_frames, frame_count
    WIDTH = screen.get_width()
    HEIGHT = screen.get_height()

    if gif_frames is None:
        gif_frames = load_gif_frames(gif_path, screen)
    ...
    music_path = r"D:\Nam2 - Ki2\Artificial Intelligence\PROJECT_AI\src\nhacnen.mp3"
    music_icon_path = r"D:\Nam2 - Ki2\Artificial Intelligence\PROJECT_AI\src\music_icon.png"
